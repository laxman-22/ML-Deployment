  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setProb(parseFloat(responseData.survival_probability))
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-row gap-4">
              ...
              <div className="w-full">
                ...
                <select id="dropdown1" value={passengerClass} onChange={handlePassengerClassChange} className="text-black cursor-pointer block w-full px-4 py-2 bg-gray-200 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
              ...
              <div className="w-full">
                ...
                <select id="dropdown2" value={gender} onChange={handleGenderChange} className="text-black cursor-pointer block w-full px-4 py-2 bg-gray-200 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            ...
            <div>
              <p>Probability of Survival: {(prob * 100).toFixed(2)}%</p>
              <p>Result: {result}</p>
